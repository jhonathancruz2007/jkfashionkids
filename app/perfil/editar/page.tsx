...
export default function EditarPerfil() {
  ...
  if (carregando) {
    return (
      <div className="flex h-[60vh] items-center justify-center bg-neutral-50">
  ...
  return (
    <div className="min-h-screen bg-neutral-50 py-10 font-sans text-neutral-800">
      <div className="mx-auto max-w-xl px-4">
        <Link
          href="/perfil"
          className="mb-4 inline-flex items-center gap-2 text-xs font-semibold text-neutral-500 hover:text-rose-600 transition-colors"
        >
        ...
        <div className="space-y-6 rounded-3xl border border-neutral-200/80 bg-white p-7 shadow-sm">
          <div>
            <h1 className="flex items-center gap-2.5 text-xl font-extrabold text-neutral-900 tracking-tight">
              <User className="h-6 w-6 text-rose-600" /> Editar Perfil
            </h1>
            <p className="mt-1 text-xs text-neutral-500">
              Atualize suas informações pessoais e endereço de entrega.
            </p>
          </div>
