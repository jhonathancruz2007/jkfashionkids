...
const redes = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5 2xl:h-6 2xl:w-6" aria-hidden="true">
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 2xl:h-6 2xl:w-6" aria-hidden="true">
...
export default function Rodape() {
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/4 w-72 sm:w-96 2xl:w-[600px] h-72 sm:h-96 2xl:h-[600px] bg-[#f48fb1]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-72 sm:w-96 2xl:w-[600px] h-72 sm:h-96 2xl:h-[600px] bg-[#81d4fa]/15 rounded-full blur-3xl pointer-events-none" />

      {/* Conteúdo Principal (Sem limite rígido de largura) */}
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-12 2xl:px-16 pt-10 sm:pt-14 pb-8 sm:pb-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 sm:gap-10 2xl:gap-16">
        
        {/* Marca & Descrição */}
        <div className="sm:col-span-2 md:col-span-5 space-y-4">
          <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-[#f48fb1]/30 shadow-2xs text-xs 2xl:text-sm font-black text-[#e91e63]">
            <Sparkles className="h-3.5 w-3.5 2xl:h-4 2xl:w-4 text-amber-500 fill-amber-500 animate-pulse" />
            Moda Infantil Divertida & Confortável
          </div>
          
          <div className="flex items-center gap-2.5 flex-wrap">
            <h2 
              className="text-2xl sm:text-3xl 2xl:text-4xl font-black tracking-tight text-stone-800 flex items-center select-none"
              style={{
            ...
            <div className="inline-flex items-center gap-1 rounded-full border border-[#f48fb1]/40 bg-[#f48fb1]/15 px-2.5 py-0.5 shadow-2xs">
              <span className="text-[10px] sm:text-xs 2xl:text-sm font-black uppercase tracking-widest text-[#e91e63]">
                Kids
              </span>
              <Sparkles className="h-3 w-3 2xl:h-4 2xl:w-4 text-amber-500 fill-amber-500 animate-pulse" />
            </div>
          </div>
          
          <p className="text-xs sm:text-sm 2xl:text-base text-stone-600 leading-relaxed font-medium max-w-md">
        ...
        <div className="sm:col-span-1 md:col-span-3 space-y-3">
          <h3 className="text-xs sm:text-sm 2xl:text-base font-black uppercase tracking-wider text-stone-800 border-b-2 border-[#f48fb1] inline-block pb-1">
            Navegação
          </h3>
          <ul className="space-y-2 text-xs sm:text-sm 2xl:text-base font-semibold">
            <li>
              <Link 
                href="/" 
        ...
        <div className="sm:col-span-1 md:col-span-4 space-y-3">
          <h3 className="text-xs sm:text-sm 2xl:text-base font-black uppercase tracking-wider text-stone-800 border-b-2 border-[#81d4fa] inline-block pb-1">
            Redes & Contato
          </h3>
          <p className="text-xs 2xl:text-sm font-medium text-stone-600">
            ...
            {redes.map((rede) => (
              <li key={rede.nome}>
                <a
                  ...
                  className={`flex h-10 w-10 sm:h-11 sm:w-11 2xl:h-12 2xl:w-12 items-center justify-center rounded-2xl border shadow-2xs transition-all duration-300 transform hover:-translate-y-1 active:scale-95 ${rede.bgClass}`}
                >
                  {rede.icon}
                </a>
              </li>
      ...
      {/* Direitos Autorais */}
      <div className="relative z-10 border-t border-stone-300/60 bg-stone-200/50 py-3.5 sm:py-4 2xl:py-5 text-center text-[11px] sm:text-xs 2xl:text-sm font-bold text-stone-600 flex flex-wrap items-center justify-center gap-1 sm:gap-1.5 px-4 shadow-inner">
        <span>© {new Date().getFullYear()} JK Fashion Kids. Feito com</span>
        <Heart className="h-3.5 w-3.5 2xl:h-4 2xl:w-4 text-[#e91e63] fill-[#e91e63] animate-pulse shrink-0" />
